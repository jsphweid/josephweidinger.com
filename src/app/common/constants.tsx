...
export const projects: ProjectTempateType[] =  [
    {
        ...
        modalContent: (
            <div>
                ...
                quick. Here is a <a href="www.youtube.com/watch?v=Jiq5TR0RN-A">
                youtube demonstration.</a> And the project is hosted
                on <a href="github.com/jsphweid/bookletMacro">Github.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                on <a href="github.com/jsphweid/Finale-Hotkey-Grid">Github.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                program. My brother, <a href="www.clayweidinger.com">Clay Weidinger</a>, wrote most
                ...
                project is hosted on <a href="github.com/jsphweid/hotkey-grid">Github.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                on <a href="www.youtube.com/watch?v=f7jjcGldl_o">Youtube.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                found <a href="www.josephweidinger.com/feedCalc/">HERE.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                project is located <a href="www.josephweidinger.com/justInTune/">HERE.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                to the live website is <a href="www.josephweidinger.com/playEquation">HERE.</a> And
                the source code: <a href="https://github.com/jsphweid/playEquation">GitHub.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                I aim for. The site <a href="https://www.josephweidinger.com/VAIL">is Here</a> and it
                is hosted <a href="https://github.com/jsphweid/VAIL">on Github Here.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                people to vote on which ones are the best. Check it
                out <a href="https://www.josephweidinger.com/AintIFunny">HERE.</a>And
                on <a href="https://github.com/jsphweid/AintIFunny">GitHub</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                more. <a href="http://www.josephweidinger.com/browserTranscribe">Here is
                a link</a> to the live website. The project is hosted <a href="https://www.github.com/jsphweid/browserTranscribe">on
                GitHub.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                ...
                site <a href="https://josephweidinger.com/aMuseMe">is hosted here</a> and
                the source can be <a href="https://www.github.com/jsphweid/aMuseMe">found
                on GitHub.</a>
            </div>
        )
    },
    {
        ...
        modalContent: (
            <div>
                This web-app is built with Spring MVC, Spring Security, MySQL, React, and is
                served up by Tomcat on my personal server. The goal of this app is to assist
                a person in charge of making schedules at a food place. It's a tool that gives
                real-time data-oriented feedback with regards to their scheduling choices. The
                live site <a href="https://josephweidinger.com/scheduleMaker">is hosted
                here</a> and the source can
                be <a href="https://www.github.com/jsphweid/scheduleMakerSpring">found on
                GitHub.</a>
            </div>
        )
    }
