...
export default class About extends React.Component<AboutProps> {
  ...
  renderBriefBio = (): JSX.Element => {
    return (
      <div className="jlw-bio">
        <p>
          Coder monkey at Carfax and independent software developer engineering
  ...
  renderSkills = (): JSX.Element => {
    const skillsDivs: JSX.Element[] = Object.keys(skills).map(
  ...
  render() {
    return (
      <Section
        className={`jlw-about ${this.props.className || ''}`}
        title="about"
      >
        {this.renderBriefBio()}
        {this.renderSkills()}
